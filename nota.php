...
$data_transaksi = mysqli_query($conn, "SELECT * FROM tb_transaksi JOIN tb_user ON tb_transaksi.id_user=tb_user.user_id JOIN ongkir ON tb_transaksi.id_ongkir=ongkir.id_ongkir WHERE id_transaksi = '" . $_GET['id'] . "'");
$d = mysqli_fetch_object($data_transaksi);
...
<head>
  ...
  <title>Nota transaksi #<?php echo $_GET['id']; ?></title>
</head>

<body>
  <main class="ticket-system">
    <div class="top">
      <h1 class="title">Nota anda sedang di proses</h1>
      <div class="printer" />
    </div>
    <div class="receipts-wrapper">
      <div class="receipts">
        <div class="receipt">
          <h1 style="margin: 0;">Blanjoo!</h1>
          <div class="route">
          ...
          <div class="details">
            <div class="item">
              ...
              <h3><?php echo $d->user_name?></h3>
            </div>
            <div class="item">
              <span>Alamat</span>
              <h3><?php echo $d->user_address?></h3>
            </div>
            <div class="item">
              <span>E-mail</span>
              <h3><?php echo $d->user_email?></h3>
            </div>
            <div class="item">
              <span>Pengiriman ke</span>
              <h3><?php echo $d->nama_kota; ?></h3>
            </div>
            <div class="item">
              <span>Total pembelian</span>
              <h3>Rp. <?php echo number_format($d->total_transaksi)?></h3>
            </div>
          </div>
          <a href="detail-transaksi.php?id=<?php echo $_GET['id'] ?>" class="button-7">Detail</a>
          <a href="produk.php" class="button-7">Kembali</a>
        </div>
        <div class="receipt qr-code">
          ...
          <div class="description">
            <h2>QRIS</h2>
            <p>Silahkan scan untuk pembayaran.</p>
          </div>
        </div>
      </div>
    </div>
